...
// Auth System
function initAuth() {
    const savedPassword = localStorage.getItem('litepos_password');
    ...
    if (!savedPassword) {
        ...
        authContent.innerHTML = `
            ...
            <p>Buat password untuk mengamankan aplikasi kasir Anda.</p>
            <input type="password" id="auth-pass" class="form-control" placeholder="Masukkan password baru">
            <input type="password" id="auth-pass-confirm" class="form-control" placeholder="Konfirmasi password">
            <button class="btn btn-primary" onclick="setupPassword()">Simpan Password</button>
        `;
    } else {
        // Login Mode
        authContent.innerHTML = `
            <h3>Login Kasir</h3>
            <p>Masukkan password untuk masuk ke sistem.</p>
            <input type="password" id="auth-pass" class="form-control" placeholder="Password">
...
window.setupPassword = function() {
    ...
    localStorage.setItem('litepos_password', pass);
    alert("Password berhasil dibuat! Silakan masuk.");
    initAuth();
};
